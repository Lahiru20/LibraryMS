...
public class MemberController implements MemeberService {
    ...
    public boolean updateMemeber(Members members) {
        try {
            ...
            new  Alert(Alert.AlertType.CONFIRMATION,"Update not Success").show();
            throw new RuntimeException(e);
    ...
    public void AddMemeber(Members members) {
        ...
        try {
            ...
            if (preparedStatement.executeUpdate()>0)new Alert(Alert.AlertType.INFORMATION,"Member Added!").show();
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
